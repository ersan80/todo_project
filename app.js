...
const input = document.createElement("input");
    input.setAttribute("class", "newInput2");
    input.setAttribute("placeholder", "please edit new todo");
...
const input = document.querySelector(".newInput2");
console.log(input)
...
console.log(e.target);
  ...
  //! event, bir edit butonundan geldi ise
   
  else if (e.target.classList.contains("fa-pen-to-square")) {
      
      e.target.parentElement.classList.toggle("edited") ? input.classList = "newInput": input.classList ="newInput2"
      console.log(e.target.parentElement.innerText)
      if(input.value){
          e.target.parentElement.innerText = input.value
          input.classList = "newInput2";
      } 
    }
});
